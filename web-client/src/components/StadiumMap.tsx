/**
 * @fileoverview Google Maps Embed — renders a zero-key satellite view of SoFi Stadium.
 *
 * Google Service: Google Maps Embed API
 * Purpose: Provides real-time venue visualization for crowd telemetry.
 * The iframe embed requires no API key and loads directly from Google servers.
 */
    ...
    return (
        <div style={{ width: '100%', height: '100%', borderRadius: '16px', overflow: 'hidden', position: 'relative', backgroundColor: 'rgba(0,0,0,0.5)' }}>
            <div className="live-badge" style={{ position: 'absolute', top: '15px', right: '15px', zIndex: 10, background: 'rgba(0,0,0,0.8)', padding: '0.5rem 1rem', borderRadius: '8px' }}>
                Google Maps: REAL-TIME TELEMETRY
            </div>
            ...
            <iframe 
                ...
                title="Google Maps Embed API — SoFi Stadium Satellite View"
            ></iframe>
        </div>
    );
}
